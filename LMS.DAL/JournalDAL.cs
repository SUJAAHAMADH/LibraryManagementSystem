    ...
    public static class JournalDAL
    {
        public static Journal Save(Journal journal, int journalID)
        {
                ...
                List<SqlParameter> param = new List<SqlParameter>
            {
                ...
                new SqlParameter { ParameterName = "@OrderDate", DbType = DbType.DateTime, Value = journal.OrderDate },
                new SqlParameter { ParameterName = "@OrderNo", DbType = DbType.String, Value = journal.OrderNo ?? (object)DBNull.Value },
                new SqlParameter { ParameterName = "@VolumeNo", DbType = DbType.String, Value = journal.VolumeNo ?? (object)DBNull.Value },
                new SqlParameter { ParameterName = "@IssueNo", DbType = DbType.String, Value = journal.IssueNo ?? (object)DBNull.Value },
                new SqlParameter { ParameterName = "@Month", DbType = DbType.String, Value = journal.Month ?? (object)DBNull.Value },
                new SqlParameter { ParameterName = "@Remark", DbType = DbType.String, Value = journal.Remark ?? (object)DBNull.Value },
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow row in dt.Rows)
                    {
                        Journal journal = new Journal
                        {
                            ...
                            OrderDate = row["OrderDate"] as DateTime? ?? DateTime.MinValue,
